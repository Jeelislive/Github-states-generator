...
import { generateTopLangsCard } from "@/lib/svg";
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const { username, theme = "default", show_icons, hide_border, layout, bg_color, title_color } = req.query;
  ...
  try {
    ...
    const svg = generateTopLangsCard(languages, selectedTheme, {
    ...
    console.error("Error generating top langs card:", error);
