...
import { generateAdditionalStatsCard } from "@/lib/svg";
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const svg = generateAdditionalStatsCard(stats, selectedTheme, {
    ...
    console.error("Error generating additional stats card:", error);
